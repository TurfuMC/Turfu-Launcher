    ...
    setTimeout(() => {
        $('#loadingContainer').fadeOut(250, () => {
            ...
            setOverlayContent(
                ...
                'Une connexion n\'a pas pu être établie avec nos serveurs pour télécharger l\'index de distribution. Aucune copie locale n\'était disponible pour le chargement. <br><br>L\'index de distribution est un fichier essentiel qui fournit les dernières informations sur le serveur. Le launcher ne peut pas démarrer sans lui. Assurez-vous que vous êtes connecté à Internet et relancez l\'application. <br><br>Vous pouvez consulter l\'états de nos serveurs à cette adrese : <a href="https://status.zendrique.ml">status.zendrique.ml</a> ',
                'Fermer'
            )
            setOverlayHandler(() => {
    ...
    if(selectedAcc != null){
        ...
        if(!val){
            ...
            setOverlayContent(
                ...
                `Nous n'avons pas pu actualiser la connexion pour <strong>${selectedAcc.displayName}</strong>. Merci ${accLen > 0 ? 'de sélectionnez un autre compte ou ' : ''} de vous reconnectez.`,
                'S\'identifier',
